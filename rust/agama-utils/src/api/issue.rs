...
#[derive(Clone, Debug, Deserialize, PartialEq, Serialize, utoipa::ToSchema, JsonSchema)]
...
// and the details.
#[derive(
    Clone, Debug, Deserialize, Serialize, PartialEq, Eq, Hash, utoipa::ToSchema, JsonSchema,
)]
#[serde(rename_all = "camelCase")]
pub struct Issue {
    pub class: String,
